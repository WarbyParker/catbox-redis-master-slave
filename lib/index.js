...
internals.Connection.prototype.start = function(callback) {
    ...
    var writeClient = Redis.createClient({
        port: this.settings.write.port,
        host: this.settings.write.host,
        tls: this.settings.write.tls
    });
    var readClient = Redis.createClient({
        port: this.settings.read.port,
        host: this.settings.read.host,
        tls: this.settings.read.tls
    });
